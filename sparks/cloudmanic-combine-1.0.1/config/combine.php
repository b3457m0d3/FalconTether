...
$config['combine']['js_base_url'] = base_url() . 'assets/js/';
$config['combine']['css_base_url'] = base_url() . 'assets/css/';
$config['combine']['cache_base_url'] = base_url() . 'assets/cache/';
...
$config['combine']['script_dir'] = 'assets/js/';
...
$config['combine']['cache_dir'] = 'assets/cache/';
