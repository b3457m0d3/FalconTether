...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
      ...
      $redir = str_replace('install/','',$redir);
			header( 'Location: ' . $redir . 'frontpage' ) ;
		}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Falcon Tether Installer</title>
    ...
    <?php if(is_writable($db_config_path)):?>
	  ...
	  <?php else: ?>
      <p class="error">Please make the /application/config/database.php file writable. <strong>Example</strong>:<br /><br /><code>chmod 777 system/application/config/database.php</code></p>
	  <?php endif; ?>
