...
' onclick='piwikMenu.onItemClick(this);'><?php echo ((is_array($_tmp=$this->_tpl_vars['level1'])) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a>
	<ul>
...
' onclick='piwikMenu.onItemClick(this);'><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['name'])) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</a></li>
		<?php endif; ?>
