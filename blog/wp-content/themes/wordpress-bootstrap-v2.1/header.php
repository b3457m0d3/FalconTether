...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link href="http://www.falcontether.cc/assets/fonts/impact-label/stylesheet.css" rel="stylesheet">
        <link href="http://www.falcontether.cc/assets/fonts/college/stylesheet.css" rel="stylesheet">
				...
				<div class="navbar navbar-fixed-top">
					<div class="navbar-inner">
						<div class="container-fluid nav-container">
							<nav role="navigation">
								<a class="brand impactlabelsmall" id="logo" title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>"><img src="http://www.falcontether.cc/assets/images/falcontether.png" width="48px" height="24px" border="0"/><?php bloginfo('name'); ?></a>
								...
								<div class="nav-collapse">
                                                                <ul class="nav">
                                                                    <li><a href="http://www.falcontether.cc">Home</a></li>
                                                                    <li><a href="http://www.falcontether.cc/forum">Community</a></li>
                                                                </ul>
                                                                </div>
